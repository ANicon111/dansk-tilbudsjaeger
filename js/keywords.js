...
const keywords = {
    ...
    "appelsin": new Keyword("fruitsandvegetables", 200, "g", false),
    ...
    "bananer": new Keyword("fruitsandvegetables", 120, "g"),
    "banan": new Keyword("fruitsandvegetables", 120, "g", false),
    "citroner": new Keyword("fruitsandvegetables", 100, "g"),
    "citron": new Keyword("fruitsandvegetables", 100, "g", false),
    ...
    "pære": new Keyword("fruitsandvegetables", 150, "g", false),
    ...
    "tomat": new Keyword("fruitsandvegetables", 80, "g", false),
    "æbler": new Keyword("fruitsandvegetables", 150, "g"),
    "æble": new Keyword("fruitsandvegetables", 150, "g", false),
    ...
    "icebergsalat": new Keyword("fruitsandvegetables", 200, "g"),
    "isbjergsalat": new Keyword("fruitsandvegetables", 200, "g"),
